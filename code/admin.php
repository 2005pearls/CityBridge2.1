    ...
    <table>
      ...
      <?php else: while ($row = $resPending->fetch_assoc()): ?>
        <tr>
          ...
          <td><a href="admin-pending.php?id=<?php echo (int)$row['permit_id']; ?>" class="table-link">Review</a></td>
        </tr>
      <?php endwhile; endif; ?>
      </tbody>
    </table>
    ...
    <table>
      ...
      <?php else: while ($row = $resApproved->fetch_assoc()): ?>
        <tr>
          ...
          <td><a href="admin-approved.php?id=<?php echo (int)$row['permit_id']; ?>" class="table-link">View</a></td>
        </tr>
      <?php endwhile; endif; ?>
      </tbody>
    </table>
    ...
    <table>
      ...
      <?php else: while ($row = $resRejected->fetch_assoc()): ?>
        <tr>
          ...
          <td><a href="admin-rejected.php?id=<?php echo (int)$row['permit_id']; ?>" class="table-link">View</a></td>
        </tr>
      <?php endwhile; endif; ?>
      </tbody>
    </table>
