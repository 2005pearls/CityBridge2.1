...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        $conn->commit();
        header("Location: permit-details-pending.php?id=" . $permit_id);
        exit();
...
<body>
  ...
  <div class="breadcrumb-container">
    <div class="breadcrumb">
      ...
      <a href="permit-details-pending.php?id=<?php echo $permit_id; ?>">Permit Details</a><span>›</span>
  ...
  <main>
    <div class="form-card wide">
      ...
      <?php if ($error): ?><p style="color:#e05c5c;text-align:center;"><?php echo e($error); ?></p><?php endif; ?>
      ...
      <form action="" method="post">
        ...
        <div class="action-row" style="margin-top: 10px;">
          <a href="permit-details-pending.php?id=<?php echo $permit_id; ?>" class="btn btn-admin">Cancel</a>
