...
<head>
  ...
  <title>Permit Details - Rejected</title>
...
<body>
  ...
  <main class="dashboard">
    ...
    <div class="page-title">
      ...
      <p>Review your rejected permit and update the required information.</p>
    </div>
    ...
    <div class="details-grid">
      <div class="panel">
        ...
        <div class="info-row"><span class="label">Reviewed Date</span><span class="value"><?php echo fmt_date($permit['reviewed_date']); ?></span></div>
        <div class="info-row"><span class="label">Status</span><span class="value"><span class="badge rejected">Rejected</span></span></div>
        <div class="info-row"><span class="label">Expiry Date</span><span class="value">—</span></div>
      </div>
    ...
    <div class="panel">
      ...
      <p class="action-note">This permit was rejected. Please submit a new request with the corrected information.</p>
    </div>
