...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!in_array($permit_type, ["labor","equipment","medical","electronic"], true)) {
        ...
        try {
            ...
            $conn->commit();
            $success = "Permit request submitted successfully! Your permit ID is " . permit_code($permit_id) . ".";
...
<body>
  ...
  <main>
    <div class="form-card wide">
      ...
      <?php if ($success): ?><p style="color:#3ecf8e;text-align:center;"><?php echo e($success); ?></p><?php endif; ?>
